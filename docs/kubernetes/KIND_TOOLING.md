...
4. Tags image as `kinotic/structures-server:<version>` from gradle.properties
...
# Load specific image
./kind-cluster.sh load --image kinotic/structures-server:0.5.0
...
./kind-cluster.sh load --image kinotic/structures-server:<version>
