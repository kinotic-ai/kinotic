import {Page, Pageable} from '@mindignited/continuum-client'
import {ArrayC3Type, FunctionDefinition, LongC3Type, ObjectC3Type, StringC3Type} from '@mindignited/continuum-idl'
import {
    IEntityService,
