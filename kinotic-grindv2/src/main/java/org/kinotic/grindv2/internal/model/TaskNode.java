...
/**
 * A step that executes one {@link Task}.
 *
 * @param sequence   the node's position within its parent definition
 * @param task       the task to execute
 * @param reloadTask executed instead of {@code task} when a resumed run finds this step
...
public record TaskNode(int sequence,
                       ...
                       Task<?> reloadTask,
                       StoreType storeType,
                       String resultName) implements StepNode {
