...
public interface IamUserService extends IdentifiableCrudService<IamUser, String> {
    ...
    CompletableFuture<IamUser> findByEmailAndScope(String email, AuthScope authScopeType, String authScopeId);

    CompletableFuture<Page<IamUser>> findByScope(AuthScope authScopeType, String authScopeId, Pageable pageable);
