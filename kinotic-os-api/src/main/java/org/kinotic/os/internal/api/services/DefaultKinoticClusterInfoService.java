...
import org.kinotic.domain.api.model.cluster.KinoticClusterInfo.KinoticClusterInfoBuilder;
import org.kinotic.domain.api.model.cluster.KinoticNodeInfo;
import org.kinotic.os.api.services.KinoticClusterInfoService;
...
public class DefaultKinoticClusterInfoService implements KinoticClusterInfoService {
    ...
    public DefaultKinoticClusterInfoService(@Autowired(required = false)
                                     Ignite ignite) {
        this.ignite = ignite;
    }
