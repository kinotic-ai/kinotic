...
public class GraalJsSpawnRenderer {
    ...
    // Initialized lazily rather than at construction: the bundle is generated by
    // :kinotic-spawn-renderer at build time and is absent in CLAUDE_CLOUD_COMPILE
    // builds, which must still be able to start a Spring context.
            ...
            try (InputStream in = GraalJsSpawnRenderer.class.getResourceAsStream(BUNDLE_RESOURCE)) {
                if (in == null) {
                    throw new IllegalStateException(
                            ...
                            + "It is generated by the :kinotic-spawn-renderer build.");
                }
