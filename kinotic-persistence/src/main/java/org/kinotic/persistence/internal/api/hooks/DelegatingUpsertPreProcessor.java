...
public class DelegatingUpsertPreProcessor implements UpsertPreProcessor<Object, Object, Object> {
    ...
    public DelegatingUpsertPreProcessor(DomainPersistenceProperties domainPersistenceProperties,
                                        JsonMapper jsonMapper,
                                        EntityDescriptor entityDescriptor,
                                        Map<String, DecoratorLogic> fieldPreProcessors) {

        tokenBufferUpsertPreProcessor = new TokenBufferUpsertPreProcessor(domainPersistenceProperties,
                                                                          jsonMapper,
                                                                          entityDescriptor,
                                                                          fieldPreProcessors);

        rawJsonUpsertPreProcessor = new RawJsonUpsertPreProcessor(domainPersistenceProperties,
                                                                  jsonMapper,
                                                                  entityDescriptor,
                                                                  fieldPreProcessors);
