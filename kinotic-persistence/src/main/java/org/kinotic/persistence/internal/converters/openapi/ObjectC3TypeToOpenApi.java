...
import org.kinotic.persistence.api.model.idl.decorators.ReadOnlyDecorator;
...
public class ObjectC3TypeToOpenApi implements C3TypeConverter<Schema<?>, ObjectC3Type, OpenApiConversionState>, Cacheable {
    ...
    public Schema<?> convert(ObjectC3Type objectC3Type,
        ...
        for(PropertyDefinition property : objectC3Type.getProperties()){
            ...
            //       Or this could be done by keeping the Conversion State around and converting all EntityDefinitions for a application at once
            if(type instanceof ComplexC3Type complexField){
