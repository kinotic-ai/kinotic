...
public abstract class AbstractJsonUpsertPreProcessor<T> implements UpsertPreProcessor<T, T, RawJson> {
    ...
    public AbstractJsonUpsertPreProcessor(JsonMapper jsonMapper,
            ...
            while (jsonParser.nextToken() != null) {
                ...
                if (token == JsonToken.PROPERTY_NAME) {
                    ...
                    if(preProcessorLogic != null){
                        ...
                        Object value = preProcessor.process(fieldName, decorator, input, context);
                        ...
                        if(entityDescriptor.multiTenancyType() == MultiTenancyType.SHARED
                                && !entityDescriptor.isMultiTenantSelectionEnabled() // just in case there is a field with the same name as TENANT_ID_FIELD_NAME
                                && currentJsonPath.equals(DomainUtil.TENANT_ID_FIELD_NAME)){
                    ...
                    if(token == JsonToken.END_OBJECT && objectDepth == 1){
                        ...
                        if(entityDescriptor.isMultiTenantSelectionEnabled() && currentTenantId == null){

                            throw new IllegalArgumentException("Could not find TenantId for Entity");

                        } else if (entityDescriptor.isMultiTenantSelectionEnabled() && currentTenantId != null) {
                        ...
                        if(entityDescriptor.multiTenancyType() == MultiTenancyType.SHARED
                            ...
                            jsonGenerator.writeStringProperty(DomainUtil.TENANT_ID_FIELD_NAME, currentTenantId);
                        }
