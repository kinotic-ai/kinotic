...
public class MapUpsertPreProcessor implements UpsertPreProcessor<Map<Object, Object>, List<Map<Object, Object>>, Map<Object, Object>> {
    ...
    public MapUpsertPreProcessor(EntityDefinition entityDefinition,
    ...
    private EntityHolder<Map<Object, Object>> preProcessData(Map<Object, Object> entity, EntityContext context) {
        ...
        String id = (String) preProcessor.process(entityDefinition, idFieldName, decorator, idFieldValue, context);
        ...
        if(entityDefinition.getMultiTenancyType() == MultiTenancyType.SHARED){
            ...
            if(entityDefinition.isMultiTenantSelectionEnabled()){
                ...
                tenantId = (String) entity.get(entityDefinition.getTenantIdFieldName());
                if(tenantId == null){
