...
import org.kinotic.domain.api.model.persistence.idl.decorators.AutoGeneratedIdDecorator;
    ...
    private EntityHolder<Map<Object, Object>> preProcessData(Map<Object, Object> entity, EntityContext context) {
        ...
        if(entityDescriptor.multiTenancyType() == MultiTenancyType.SHARED){
            ...
            if(entityDescriptor.isMultiTenantSelectionEnabled()){
                ...
                tenantId = (String) entity.get(domainPersistenceProperties.getTenantIdFieldName());
                ...
                if (tenantId != null && !tenantId.equals(context.requireTenantId())) {
                    ...
                    entity.put(domainPersistenceProperties.getTenantIdFieldName(), tenantId);
                }
            }
        }else {
            tenantId = null;
