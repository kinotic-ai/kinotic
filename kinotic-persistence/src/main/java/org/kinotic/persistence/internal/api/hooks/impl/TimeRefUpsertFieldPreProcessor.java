...
import org.kinotic.domain.api.model.persistence.idl.decorators.TimeReferenceDecorator;
...
public class TimeRefUpsertFieldPreProcessor implements UpsertFieldPreProcessor<TimeReferenceDecorator, Date, Date> {
    ...
    @Override
    public Date process(String fieldName, TimeReferenceDecorator decorator, Date fieldValue, EntityContext context) {
        return fieldValue;
    }
}
