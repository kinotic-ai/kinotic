...
A project is a functional unit within an application. Each project has its own `package.json` and a `.config/kinotic.config.ts` configuration file that tells the CLI how the project relates to the broader application.
