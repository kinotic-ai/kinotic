...
After defining your entities and running `kinotic sync`, you get fully typed service classes for each entity. These services provide a complete set of data operations.
