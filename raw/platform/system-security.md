...
<tbody>
  <tr>
    ...
    <td>
      Customer org admins and members
    </td>
    
    <td>
      Email/password or OIDC (platform-social or per-org SSO) — see <a href="/platform/organization-management">
  ...
  <tr>
    ...
    <td>
      End-users of an application owned by an org
    </td>
    
    <td>
      Email/password or OIDC — credentials and OIDC configs are scoped to the application
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Platform operators running kinotic-server itself
    </td>
    
    <td>
      Out of scope for OIDC; handled via a separate, infrastructure-tier path (deferred)
    </td>
  </tr>
</tbody>
</table>
