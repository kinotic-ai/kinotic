 ...
 * UI's first publish with a hostname label of its own, and the upload of the built UIs through a
 * foreground publish workload holding nothing but a short-lived upload URL per site.
 */
@Component
