...
public final class ProjectDeployStores {
    ...
    /**
     * The {@link org.kinotic.management.api.model.deployment.ProjectSbom} the run left the project
     * with, generated by the run or kept from an earlier one whose dependencies were the same.
     * Known before the task completes through {@link DeployTarget#sbomWorkloadId()}, which is what
     * lets a watcher follow the SBOM workload's logs while the task runs.
     */
