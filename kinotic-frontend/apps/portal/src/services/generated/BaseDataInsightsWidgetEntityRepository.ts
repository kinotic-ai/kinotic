...
/**
 * Base Repository for interacting with DataInsightsWidget entities
 * This class was generated by the Structures CLI. And will be overwritten if the CLI is run again.
 */
export class BaseDataInsightsWidgetEntityRepository extends EntityRepository<DataInsightsWidget> {
