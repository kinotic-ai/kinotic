...
public class McpToolDirectoryTests extends KinoticTestBase {
    ...
    private static final String PROJECT_SERVICE = "management-api~org.kinotic.os.api.services.ProjectService";
    private static final String APPLICATION_SERVICE = "management-api~org.kinotic.os.api.services.ApplicationService";
