...
/**
 * Base Repository for interacting with PersonWithTenant entities
 * This class was generated by the Kinotic CLI. And will be overwritten if the CLI is run again.
 */
export class BasePersonWithTenantRepository extends EntityRepository<PersonWithTenant> {

  private readonly shouldValidate: boolean

  constructor(shouldValidate: boolean = true, entitiesRepository?: IEntitiesRepository) {
    super('kinotic-test', 'vBTFHVuFwd', 'PersonWithTenant', entitiesRepository)
