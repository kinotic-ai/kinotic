 ...
 * workload's traces and metrics, and the credential its guest must present there. Both hold
 * for the workload's life, since the guest's environment is set when its VM is created.
 */
