...
export enum KinoticPersistenceDecorator {
 ...
 */
export function AutoGeneratedId(target: any, propertyKey: string): void {
    Reflect.defineMetadata(KinoticPersistenceDecorator.AutoGeneratedId, {}, target, propertyKey)
...
export function Discriminator(propertyName: string){
    return function(target: any, propertyKey: string): void {
        Reflect.defineMetadata(KinoticPersistenceDecorator.Discriminator, new DiscriminatorConfig(propertyName), target, propertyKey)
    }
}
...
export function Entity(multiTenancyType: MultiTenancyType = MultiTenancyType.NONE,
    ...
    return function (constructor: Function): void {
        Reflect.defineMetadata(KinoticPersistenceDecorator.Entity, new EntityConfig(multiTenancyType, entityType), constructor)
    }
}
...
export function Flattened(target: any, propertyKey: string): void {
    Reflect.defineMetadata(KinoticPersistenceDecorator.Flattened, {}, target, propertyKey)
}
...
export function Id(target: any, propertyKey: string): void {
    Reflect.defineMetadata(KinoticPersistenceDecorator.Id, {}, target, propertyKey)
}

export function Nested(target: any, propertyKey: string): void {
    Reflect.defineMetadata(KinoticPersistenceDecorator.Nested, {}, target, propertyKey)
}

/**
 * Signifies that a property is not indexed in Elasticsearch.
 */
export function NotIndexed(_target: any, _propertyKey: string): void {
}

export function NotNull(target: any, propertyKey: string): void {
    Reflect.defineMetadata(KinoticPersistenceDecorator.NotNull, {}, target, propertyKey)
}
...
export function Precision(precisionType: PrecisionType = PrecisionType.INT){
    return function(target: any, propertyKey: string): void {
        Reflect.defineMetadata(KinoticPersistenceDecorator.Precision, new PrecisionConfig(precisionType), target, propertyKey)
    }
}
...
export function Query(statements: string) {
    return function (target: any, key: string, descriptor: PropertyDescriptor): PropertyDescriptor {
        Reflect.defineMetadata(KinoticPersistenceDecorator.Query, statements, target, key)
        return descriptor;
    }
}
...
export function Text(target: any, propertyKey: string): void {
    Reflect.defineMetadata(KinoticPersistenceDecorator.Text, {}, target, propertyKey)
}

/**
 * This is used for data streams to signify the field that should be used as the time reference.
 */
export function TimeReference(_target: any, _propertyKey: string): void {
}

export function Version(_target: any, _propertyKey: string): void {
}

export function TenantId(_target: any, _propertyKey: string): void {
}
