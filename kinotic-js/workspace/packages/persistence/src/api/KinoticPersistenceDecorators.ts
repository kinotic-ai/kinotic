...
/**
 * Signifies that a property holds a date, which is stored and queried as a date.
 * The property is a string, or an array of strings, holding ISO-8601 dates such as `Date.prototype.toISOString()` returns.
 */
export function DateTime(_value: undefined,
                         _context: ClassFieldDecoratorContext<unknown, string | readonly string[] | null | undefined>): void {
}
