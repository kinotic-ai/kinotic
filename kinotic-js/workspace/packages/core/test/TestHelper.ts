...
/**
 * Returns the client-test server's Docker image, tagged with the kinoticVersion from gradle.properties
 */
export function getKinoticDockerImage(): string {
    ...
    return `kinoticai/kinotic-client-test-server:${version.trim()}`
}
