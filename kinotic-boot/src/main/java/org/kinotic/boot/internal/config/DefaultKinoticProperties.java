...
public class DefaultKinoticProperties implements KinoticProperties {
    ...
    private IgniteProperties ignite = new DefaultIgniteProperties();
    ...
    public DefaultKinoticProperties setMaxNumberOfCoresToUse(int maxNumberOfCoresToUse) {
