...
INSERT INTO kinotic_participant_identity (id, email, displayName, authType, organizationId, applicationId, tenantId, enabled) VALUES ('00000000-0000-0000-0000-000000000003', 'app-e2e-datastream-kinotic@test.local', 'e2e DataStream App User', 'LOCAL', 'kinotic-test', 'e2e-datastream', 'kinotic', true) WITH REFRESH;
INSERT INTO kinotic_participant_identity (id, email, displayName, authType, organizationId, applicationId, tenantId, enabled) VALUES ('00000000-0000-0000-0000-000000000004', 'app-e2e-admin-entity-kinotic@test.local', 'e2e AdminEntityService App User', 'LOCAL', 'kinotic-test', 'e2e-admin-entity', 'kinotic', true) WITH REFRESH;
INSERT INTO kinotic_participant_identity (id, email, displayName, authType, organizationId, applicationId, tenantId, enabled) VALUES ('00000000-0000-0000-0000-000000000005', 'app-e2e-named-query-kinotic@test.local', 'e2e NamedQuery App User', 'LOCAL', 'kinotic-test', 'e2e-named-query', 'kinotic', true) WITH REFRESH;
INSERT INTO kinotic_participant_identity (id, email, displayName, authType, organizationId, applicationId, tenantId, enabled) VALUES ('00000000-0000-0000-0000-000000000006', 'app-e2e-versioned-kinotic@test.local', 'e2e Versioned App User', 'LOCAL', 'kinotic-test', 'e2e-versioned', 'kinotic', true) WITH REFRESH;
INSERT INTO kinotic_participant_identity (id, email, displayName, authType, organizationId, applicationId, tenantId, enabled) VALUES ('00000000-0000-0000-0000-000000000007', 'app-e2e-entity-service-kinotic@test.local', 'e2e EntityService App User', 'LOCAL', 'kinotic-test', 'e2e-entity-service', 'kinotic', true) WITH REFRESH;
INSERT INTO kinotic_participant_identity (id, email, displayName, authType, organizationId, applicationId, tenantId, enabled) VALUES ('00000000-0000-0000-0000-000000000008', 'app-e2e-admin-named-query-kinotic@test.local', 'e2e AdminNamedQuery App User', 'LOCAL', 'kinotic-test', 'e2e-admin-named-query', 'kinotic', true) WITH REFRESH;
INSERT INTO kinotic_participant_identity (id, email, displayName, authType, organizationId, applicationId, tenantId, enabled) VALUES ('00000000-0000-0000-0000-000000000009', 'app-e2e-mcp-kinotic@test.local', 'e2e Mcp App User', 'LOCAL', 'kinotic-test', 'e2e-mcp', 'kinotic', true) WITH REFRESH;
