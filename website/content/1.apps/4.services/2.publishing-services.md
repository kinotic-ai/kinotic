...
A method decorator that marks a method whose final parameter receives the request context. The context carries information about the caller, such as the authenticated participant.
