...
Advertises the service in the platform service directory, so it appears in directory listings for browsing and invocation. Publishing alone makes a service callable over RPC; advertising is the separate, intentional act of listing it.
