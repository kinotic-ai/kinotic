...
The endpoint ships with the domain module and is enabled whenever the module is; a deployment running with `kinotic.disableDomain: true` has no MCP endpoint.
