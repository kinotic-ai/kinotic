...
export class NotificationService implements INotificationService {
    ...
    constructor(kinotic: IKinotic) {
        ...
        // A platform service is reached in os-api or kinotic-app-api; an application's own service
        // is reached in its app zone, e.g. kinotic-app.acme-org.orders-app.com.example.NotificationService
        this.serviceProxy = kinotic.serviceProxy('kinotic-app.acme-org.orders-app.com.example.NotificationService')
    }
