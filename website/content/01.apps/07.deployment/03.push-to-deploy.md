...
platform issues for fifteen minutes once it has authorized you; `ProjectService.findDeployment`,
whose `sbom` it is, and `ProjectService.findSbomDocumentUrl` serve the same to any client of your
organization, MCP hosts included.
