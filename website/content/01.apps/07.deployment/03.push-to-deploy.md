...
A deployment runs as a job with four steps, visible with live progress on the project's
...
4. **Ensure runtime workload** — the first deployment starts the long-lived VM that runs
