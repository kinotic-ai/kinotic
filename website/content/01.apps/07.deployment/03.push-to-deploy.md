...
is generated. The project's **SBOM** page shows it for the last synced commit with when it was
generated, lists its components, searchable by name and license and filtered by how the project
uses them, and downloads the document as it is. The page reads the document through a URL the
