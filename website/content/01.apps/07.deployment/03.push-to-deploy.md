...
platform issues for fifteen minutes once it has authorized you; `ProjectSbomService.findSbom`
and `ProjectSbomService.findDocumentUrl` serve the same to any client of your organization.
