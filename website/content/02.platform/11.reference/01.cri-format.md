...
|-------------|-------------|-------------|
| APPLICATION (org, app) | `app-api`, `kinotic-app.<org>.<app>` | reply destinations only |
| ORGANIZATION (org) | `os-api`, `app-api`, `kinotic-app.<org>.*` | `kinotic-app.<org>.*` — its applications' zones |
