...
```
srv://management-api~org.kinotic.os.api.services.ProjectService/findByRepoFullName
```
...
| CRI | Description |
|-----|-------------|
| `srv://management-api~org.kinotic.os.api.services.security.MemberService` | A platform service in the `management-api` zone |
