...
`KINOTIC_MANAGEMENTAPI_ORGANIZATIONSTORAGE_*` environment variables (see
...
`kinotic.tf` passes the profile, endpoint and zone as `KINOTIC_MANAGEMENTAPI_UIDEPLOYMENT_*`
