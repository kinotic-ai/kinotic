...
4. **The function name.** This is the last resort, so whatever it yields is what gets served — there is nothing left to fall through to. Every word of the name counts, not just the leading verb, and the first matching rule wins:
