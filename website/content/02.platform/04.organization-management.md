...
|---|---|---|---|
| **Platform OIDC** (social) | `OrgSignupOidcConfiguration` | Nothing — every enabled row is offered | A "Continue with Google/Microsoft/…" button on the login *and* signup pages |
