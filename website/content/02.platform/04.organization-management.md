...
| `OAuthServerHandler`, `McpJsonRpcHandler` | ✓ | ✓ | |
...
| `GET` | `/api/auth/oauth/authorize` | `OAuthServerHandler` | PKCE authorization-code flow; redirects to the `/oauth/consent` page on the server's UI |
