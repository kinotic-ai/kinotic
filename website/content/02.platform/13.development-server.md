...
| `kinotic.domain.apiBaseUrl` | `https://dev-api.kinotic.ai` | REST, STOMP, MCP, and the OIDC redirect URIs; the router's 443 is the api-gateway port, and `issuerBaseUrl` falls back to it |
