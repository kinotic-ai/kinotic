...
in the account's `organizations` container. Today the one use is each project's SBOM, under
`organizations/<organizationId>/sboms/<projectId>/`. The account is configured under
