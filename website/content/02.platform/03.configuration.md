...
| `kinotic.managementApi.tempo.url` | `KINOTIC_MANAGEMENTAPI_TEMPO_URL` | — | `http://localhost:3200` |
| `kinotic.managementApi.mimir.url` | `KINOTIC_MANAGEMENTAPI_MIMIR_URL` | — | `http://localhost:9009` |
