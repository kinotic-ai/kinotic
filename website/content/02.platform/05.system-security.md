...
Org members manage their organization's machines through the published `MachineService` — create (disclosing the generated secret once), list, rotate the secret, disable/enable, and remove — surfaced in the SPA as the **Machines** page. Every operation is bound to the caller's organization; machines of other organizations are invisible.
