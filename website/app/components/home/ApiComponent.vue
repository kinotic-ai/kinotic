...
const capabilities: Capability[] = [
  {
    ...
    code: [
      [t('c', '// a frontend that calls your services')],
      [t('k', 'import'), t('p', ' { Kinotic } '), t('k', 'from'), t('t', " '@kinotic-ai/core'")],
      [t('k', 'await'), t('p', ' Kinotic.connect()')],
      [t('k', 'const'), t('p', ' orders = Kinotic.serviceProxy(')],
      [t('t', "  'app.acme-org.orders-app~com.example.OrderService'"), t('p', ')')],
      [t('k', 'await'), t('p', ' orders.invoke('), t('t', "'reprice'"), t('p', ', [])')],
      ...
      [t('d', '$ '), t('b', 'git push')],
      [t('s', '✓ '), t('b', 'orders-console '), t('s', 'deployed')],
    ],
  },
  {
    id: 'microservices',
    ...
    icon: 'Microservices',
    file: 'services/src/PricingService.ts',
    code: [
      [t('c', '// a long-running service')],
      [t('k', 'import'), t('p', ' { Publish, Version } '), t('k', 'from'), t('t', " '@kinotic-ai/core'")],
      [t('a', '@Version'), t('p', '('), t('t', "'1.0.0'"), t('p', ')')],
      [t('a', '@Publish'), t('p', '('), t('t', "'com.example'"), t('p', ')')],
      [t('k', 'class'), t('p', ' PricingService {')],
      [t('p', '  quote(order: '), t('t', 'Order'), t('p', '): '), t('t', 'Promise<Quote>'), t('p', ' { ... }')],
      [t('p', '}')],
      [t('c', '// the platform provides:')],
      [t('g', '→ a typed proxy for every published method')],
      [t('g', '→ zone-scoped RPC addressing')],
      [t('g', '→ tracing across service boundaries')],
      [t('d', '$ '), t('b', 'git push')],
      [t('s', '✓ '), t('b', 'pricing-service '), t('s', 'live')],
    ],
  },
  {
    id: 'mcp-tools',
    ...
    icon: 'McpTools',
    file: 'services/src/OrderService.ts',
    code: [
      [t('c', '// every published method, an MCP tool')],
      [t('k', 'import'), t('p', ' { McpTool, Publish } '), t('k', 'from'), t('t', " '@kinotic-ai/core'")],
      [t('a', '@Publish'), t('p', '('), t('t', "'com.example'"), t('p', ')')],
      [t('k', 'class'), t('p', ' OrderService {')],
      [t('p', '  '), t('a', '@McpTool'), t('p', '({ title: '), t('t', "'Find Order'"), t('p', ',')],
      [t('p', '             description: '), t('t', "'Finds an order by its id'"), t('p', ',')],
      [t('p', '             readOnlyHint: '), t('t', 'true'), t('p', ' })')],
      [t('p', '  findById(orderId: '), t('t', 'string'), t('p', '): '), t('t', 'Promise<Order>'), t('p', ' { ... }')],
      [t('p', '}')],
      [t('c', '// the platform provides:')],
      [t('g', '→ tools served at POST /mcp')],
      [t('g', '→ each caller sees only the tools they may reach')],
  ...
  },
  {
    ...
    icon: 'Persistence',
    file: 'data/src/Order.ts',
    code: [
      [t('c', '// define the domain model')],
      [t('k', 'import'), t('p', ' { Entity, AutoGeneratedId } '), t('k', 'from'), t('t', " '@kinotic-ai/persistence'")],
      [t('a', '@Entity'), t('p', '()')],
      [t('k', 'export class'), t('p', ' Order {')],
      [t('p', '  '), t('a', '@AutoGeneratedId')],
      [t('p', '  id: '), t('t', 'string | null'), t('p', ' = '), t('t', 'null')],
      [t('p', '  customer: '), t('t', 'string'), t('p', ' = '), t('t', "''")],
      [t('p', '}')],
      [t('c', '// generated for you:')],
      [t('g', '→ a typed repository with full CRUD')],
      [t('g', '→ search, pagination and counts')],
      [t('d', '$ '), t('b', 'kinotic sync -p')],
      [t('s', '✓ '), t('b', 'Order '), t('s', 'synced')],
    ],
  },
]
