...
const capabilities: Capability[] = [
  {
    ...
    icon: 'Frontends',
    file: 'web/src/orders.ts',
    code: [
      [t('c', '// your UI — React, Vue, or anything that builds to static')],
      [t('k', 'const'), t('p', ' orders = '), t('k', 'new'), t('p', ' OrderRepository()')],
      [t('k', 'const'), t('p', ' page = '), t('k', 'await'), t('p', ' orders.findAll({ page: '), t('t', '0'), t('p', ', size: '), t('t', '25'), t('p', ' })')],
  ...
  },
  {
    ...
    code: [
      ...
      [t('p', '  reprice(): '), t('t', 'Promise<Batch>'), t('p', ' { ... }')],
      [t('p', '}')],
      [t('c', '// the platform provides:')],
  ...
  },
  {
    ...
    code: [
      [t('c', '// mark a method as an MCP tool')],
