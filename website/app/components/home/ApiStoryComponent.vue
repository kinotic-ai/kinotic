    ...
    slides: [
      {
        ...
        code: [
          ...
          [t('p', '  '), t('a', '@TenantId'), t('c', '            // set for you')],
          [t('p', '  tenantId: '), t('t', 'string'), t('p', ' = '), t('t', "''")],
          [t('p', '  '), t('a', '@NotNull'), t('p', ' '), t('a', '@Text'), t('c', '        // searchable')],
      ...
      },
      {
        ...
        code: [
          ...
          [t('p', '  '), t('a', '@Query'), t('p', '(')],
          [t('p', '    '), t('t', "'SELECT AVG(priority) FROM Todo'")],
          [t('p', '  )')],
          [t('p', '  avgPriority(): '), t('t', 'Promise<number>'), t('p', ' { }')],
          [t('p', '}')],
          [],
          [t('c', '// the CLI writes the body — aggregate')],
          [t('c', '// queries today, SELECT next')],
        ],
      },
      {
        ...
        code: [
          ...
          [],
          [t('k', 'const'), t('p', ' todo = '), t('k', 'await'), t('p', ' todos.save({')],
          [t('p', '  id: '), t('t', 'null'), t('p', ', title: '), t('t', "'Regrease the pump'")],
          [t('p', '})')],
          [t('k', 'const'), t('p', ' page = '), t('k', 'await'), t('p', ' todos.search('), t('t', "'pump'"), t('p', ', {')],
          [t('p', '  page: '), t('t', '0'), t('p', ', size: '), t('t', '20'), t('p', ' })')],
          [t('k', 'const'), t('p', ' open = '), t('k', 'await'), t('p', ' todos.countByQuery(')],
          [t('p', '  '), t('t', "'done = false'"), t('p', ')')],
          [],
          [t('c', '// every call is tenant-filtered')],
        ],
      },
    ],
  },
    ...
    slides: [
      {
        ...
        code: [
          ...
          [t('p', '}')],
          [],
          [t('c', '// → srv://app.acme.todo-app~…TodoService')],
        ],
      },
      {
        file: 'web/src/TodoServiceProxy.ts',
        code: [
          [t('c', '// the caller side — a typed proxy')],
          ...
          [t('p', '    '), t('k', 'return'), t('p', ' this.proxy.invoke(')],
          [t('p', '      '), t('t', "'complete'"), t('p', ', [id])')],
          [t('p', '  }')],
          [t('p', '}')],
        ],
      },
    ...
    slides: [
      {
        ...
        code: [
          ...
          [t('c', '// the OIDC session cookie and the')],
          [t('c', "// page's own origin resolve it")],
          [t('k', 'await'), t('p', ' Kinotic.connect()')],
          [],
          [t('k', 'const'), t('p', ' todos = '), t('k', 'new'), t('p', ' TodoRepository()')],
    ...
    slides: [
      {
        file: 'microservices/main/src/TodoService.ts',
        code: [
          [t('c', '// the service you already wrote')],
          [t('p', '  '), t('a', '@McpTool'), t('p', '({')],
          [t('p', '    title: '), t('t', "'Find Todo'"), t('p', ',')],
          [t('p', '    description: '), t('t', "'Finds a todo by id'"), t('p', ',')],
          [t('p', '    readOnlyHint: '), t('t', 'true'), t('p', ',')],
          [t('p', '    idempotentHint: '), t('t', 'true')],
          [t('p', '  })')],
      ...
      },
      {
        ...
        code: [
          [t('p', '{')],
          [t('p', '  '), t('t', '"mcpServers"'), t('p', ': {')],
          [t('p', '    '), t('t', '"kinotic"'), t('p', ': {')],
          [t('p', '      '), t('t', '"url"'), t('p', ':')],
          [t('p', '        '), t('t', '"https://api.acme.kinotic.ai/mcp"')],
          [t('p', '    }')],
          [t('p', '  }')],
          [t('p', '}')],
          [],
          [t('c', '// OAuth 2.1, discovered by the host')],
          [],
          [t('d', '> '), t('b', '"which todos are overdue?"')],
          [t('s', '✓ '), t('b', '3 found '), t('d', 'via TodoService')],
          [],
          [t('c', '// each caller is served only the')],
          [t('c', '// tools their participant may reach')],
        ],
      },
    ],
  },
