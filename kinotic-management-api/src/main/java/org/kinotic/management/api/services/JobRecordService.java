...
public interface JobRecordService {
     ...
     */
    Future<JobRun> saveJobRun(JobRun jobRun);
     ...
     */
    Future<JobRun> findJobRunById(String jobRunId);
     ...
     */
    Future<Page<JobRun>> findAllJobRuns(Pageable pageable);
     ...
     * @return a future that will complete with the page of runs
     */
    Future<Page<JobRun>> findJobRunsForOwner(JobOwner owner, Pageable pageable);
     ...
     */
    Future<TaskRecord> saveTaskRecord(TaskRecord taskRecord);
     ...
     */
    Future<Page<TaskRecord>> findTaskRecordsForJobRun(String jobRunId, Pageable pageable);
