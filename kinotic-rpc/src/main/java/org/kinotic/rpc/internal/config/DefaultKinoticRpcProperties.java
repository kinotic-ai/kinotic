...
public class DefaultKinoticRpcProperties implements KinoticRpcProperties {
    ...
    public DefaultKinoticRpcProperties setMaxNumberOfCoresToUse(int maxNumberOfCoresToUse) {
